...
# Słownik z danymi:
slownik = {"data": datetime.datetime.now().date().isoformat(), "miejsce": 6, "pacjent": 5, "typ_pomiaru": "Temperatura", "wartosc": 27.6}
...
def main():
    ...
    while True:
       ...
       if arg.humidity or arg.all:
           ...
           temp_i_hum = tag.humidity.read()
           temp = temp_i_hum[0]
           print("Humidity: ", temp_i_hum)
       if arg.barometer or arg.all:
